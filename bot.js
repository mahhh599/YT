            ...
            if(command == "bco") {
                if(!message.member.hasPermission("ADMINISTRATOR")) {
                    ...
                    if(!args) {
                        ...
                        message.channel.send(`**هل أنت متأكد من إرسالك البرودكاست؟\nمحتوى البرودكاست: \`${args}\`**`).then(m => {
                            m.react(":jack_o_lantern: ")
                            .then(() => m.react(":jack_o_lantern: "));

                            let yesFilter = (reaction, user) => reaction.emoji.name == ":jack_o_lantern: " && user.id == message.author.id;
                            let noFiler = (reaction, user) => reaction.emoji.name == ":jack_o_lantern: " && user.id == message.author.id;
